...
use App\Http\Controllers\GastAlbumController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //MEDIA STREAM (user)
    Route::get('/media/{media_id}/stream', [MediaController::class, 'streamUserMedia'])
...
Route::prefix('gast')->group(function () {
    Route::get('/{album_id}/media/stream/{type}/{media_id}', [GastAlbumController::class, 'streamMedia'])
        ->name('gast.media.stream');
    Route::get('/{album_id}', [GastAlbumController::class, 'show']);
    Route::post('/{album_id}/verify-pin', [GastAlbumController::class, 'verifyPin']);
    Route::get('/{album_id}/media', [GastAlbumController::class, 'media']);
    Route::get('/albums/{album_id}/gast/download', [GastAlbumController::class, 'downloadZip']);
    Route::post('/{album_id}/upload', [UploadController::class, 'upload'])->defaults('isGast', true);
});
