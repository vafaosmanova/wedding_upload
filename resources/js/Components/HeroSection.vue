<template>
    <section class="relative py-12 px-5 min-h-screen bg-gradient-to-r from-purple-200 to-purple-800-800 flex justify-center items-center overflow-hidden">

        <div class="hidden md:flex flex-col gap-8 absolute left-0 top-1/4 z-0">
            <img src="/assets/images/img1.jpg" alt="Couple 1" class="w-64 md:w-80 animate-float-slow rounded-xl shadow-lg"/>
        ...
        <div class="hidden md:flex flex-col gap-8 absolute right-0 top-1/4 z-0">
            <img src="/assets/images/img3.jpg" alt="Couple 3" class="w-56 md:w-72 animate-float-variation2 rounded-xl shadow-lg"/>
            <img src="/assets/images/img4.jpg" alt="Couple 4" class="w-64 md:w-80 animate-float-variation3 rounded-xl shadow-lg"/>
        </div>
    </section>
...
.animate-float-variation1 { animation: float-variation1 7s ease-in-out infinite; }
.animate-float-variation2 { animation: float-variation2 6.5s ease-in-out infinite; }
.animate-float-variation3 { animation: float-variation3 7.5s ease-in-out infinite; }
.animate-float-variation4 { animation: float-variation4 8s ease-in-out infinite; }
</style>
